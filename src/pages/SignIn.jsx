    ...
    <div className='flex justify-center'>
      <div className='flex'>
        <div className=' mt-[140px]'>
          <h1 className='font-sans font-bold text-[#11175D] text-[18px] lg:text-[35px]'>Login to your account!</h1>
          ...
          <div className="mt-[62px] relative">
            <input
              ...
              className=' py-[20px]  border-b-[2px] outline-0 text-[#11175D] border-[#11175D] border-opacity-[0.3] placeholder:text-[#03014C] placeholder:font-semibold placeholder:text-opacity-[0.4] placeholder:text-[20px]'
            />
          ...
          <div className="mt-[54px] relative ">
            <input
              ...
              className='py-[20px] pr-[65px] border-b-[2px] outline-0 text-[#11175D] border-[#11175D] border-opacity-[0.3] placeholder:text-[#03014C] placeholder:font-semibold placeholder:text-[20px] placeholder:text-opacity-[0.4]'
            />
